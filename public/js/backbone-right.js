...
(function() {
  ...
  // For Backbone's purposes, RightJS owns the `$` variable.
  var $ = root.RightJS;
  ...
  _.extend(Backbone.History.prototype, {
    ...
    start: function(options) {
      ...
      if (oldIE) {
         ...
         */
        var iframeElem = new Element('iframe',{src : 'javascript:0', tabindex : '-1', style : {display: 'none'}});
        var bodyElem = $(document.body);
        //this.iframe = $('<iframe src="javascript:0" tabindex="-1" />').hide().appendTo('body')[0].contentWindow;
        //this.iframe = bodyElem.append(iframeElem);
        
        var ifrm = document.createElement("IFRAME"); 
        ifrm.setAttribute("src", "javascript:0");
